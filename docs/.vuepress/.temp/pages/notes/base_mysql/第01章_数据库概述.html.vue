<template><div><h1 id="第01章-数据库概述" tabindex="-1"><a class="header-anchor" href="#第01章-数据库概述" aria-hidden="true">#</a> 第01章_数据库概述</h1>
...
<img src="@source/notes/base_mysql/images/image-20211020180934455.png" alt="image-20211020180934455" style="zoom:80%;" />
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>学号     课程编号  
1        1001
2        1001
1        1002
