<template><div><h1 id="第02章-mysql环境搭建" tabindex="-1"><a class="header-anchor" href="#第02章-mysql环境搭建" aria-hidden="true">#</a> 第02章_MySQL环境搭建</h1>
...
<img src="@source/notes/base_mysql/images/image-20211014154006530.png" alt="image-20211014154006530" style="zoom:90%;" />
<p>⑥ 完成卸载。单击“Finish”（完成）按钮即可。如果想要同时卸载MySQL8.0的安装向导程序，勾选“Yes，Uninstall MySQL Installer”即可，如图所示。</p>
<img src="@source/notes/base_mysql/images/image-20211014154046268.png" alt="image-20211014154046268" style="zoom:80%;" />
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Services\Eventlog\Application\MySQL服务 目录删除
...
<img src="@source/notes/base_mysql/images/image-20211014170553535.png" alt="image-20211014170553535" style="zoom:90%;" />
...
<img src="@source/notes/base_mysql/images/image-20211014170638699.png" alt="image-20211014170638699" style="zoom:80%;" />
<p>此时如果直接“Next”（下一步），则产品的安装路径是默认的。如果想要自定义安装目录，则可以选中对应的产品，然后在下面会出现“Advanced Options”（高级选项）的超链接。</p>
<img src="@source/notes/base_mysql/images/image-20211014170814386.png" alt="image-20211014170814386" style="zoom:80%;" />
...
<img src="@source/notes/base_mysql/images/image-20211014170857263.png" alt="image-20211014170857263" style="zoom:80%;" />
<p>步骤4：在上一步选择好要安装的产品之后，单击“Next”（下一步）进入确认窗口，如图所示。单击“Execute”（执行）按钮开始安装。</p>
<img src="@source/notes/base_mysql/images/image-20211014170934889.png" alt="image-20211014170934889" style="zoom:90%;" />
<p>步骤5：安装完成后在“Status”（状态）列表下将显示“Complete”（安装完成），如图所示。</p>
<img src="@source/notes/base_mysql/images/image-20211014171002259.png" alt="image-20211014171002259" style="zoom:90%;" />
...
<img src="@source/notes/base_mysql/images/clip_image002-1634203188594.jpg" alt="img" style="zoom:80%;" />
<p>步骤2：单击“Next”（下一步）按钮，进入MySQL服务器类型配置窗口，如图所示。端口号一般选择默认端口号3306。</p>
<img src="@source/notes/base_mysql/images/clip_image004-1634203188595.jpg" alt="img" style="zoom:80%;" />
<p>其中，“Config Type”选项用于设置服务器的类型。单击该选项右侧的下三角按钮，即可查看3个选项，如图所示。</p>
<img src="@source/notes/base_mysql/images/clip_image006-1634203188595.jpg" alt="img" style="zoom:80%;" />
<ul>
<li>
...
<img src="@source/notes/base_mysql/images/clip_image008-1634203188595.jpg" alt="img" style="zoom:80%;" />
...
<img src="@source/notes/base_mysql/images/clip_image010-1634203188595.jpg" alt="img" style="zoom:80%;" />
...
<img src="@source/notes/base_mysql/images/clip_image012-1634203188596.jpg" alt="img" style="zoom:80%;" />
<p>步骤6：单击“Next”（下一步）按钮，打开确认设置服务器窗口，单击“Execute”（执行）按钮。</p>
<img src="@source/notes/base_mysql/images/clip_image014-1634203188596.jpg" alt="img" style="zoom:80%;" />
<p>步骤7：完成配置，如图所示。单击“Finish”（完成）按钮，即可完成服务器的配置。</p>
<img src="@source/notes/base_mysql/images/clip_image016.jpg" alt="img" style="zoom:80%;" />
<p>步骤8：如果还有其他产品需要配置，可以选择其他产品，然后继续配置。如果没有，直接选择“Next”（下一步），直接完成整个安装和配置过程。</p>
<img src="@source/notes/base_mysql/images/clip_image018.jpg" alt="img" style="zoom:80%;" />
<p>步骤9：结束安装和配置。</p>
<img src="@source/notes/base_mysql/images/clip_image020.jpg" alt="img" style="zoom:80%;" />
...
<p>步骤1：在桌面上右击【此电脑】图标，在弹出的快捷菜单中选择【属性】菜单命令。
...
<img src="@source/notes/base_mysql/images/image-20211014184425147.png" alt="image-20211014184425147" style="zoom:80%;" />
<blockquote>
<p>说明：仅限于root用户</p>
</blockquote>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>mysql -h 主机名 -P 端口号 -u 用户名 -p密码
...
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code>mysql <span class="token operator">-</span>hlocalhost <span class="token operator">-</span>P3306 <span class="token operator">-</span>uroot <span class="token operator">-</span>pabc123
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>（2）密码建议在下一行输入，保证安全</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code>mysql <span class="token operator">-</span>h localhost <span class="token operator">-</span>P <span class="token number">3306</span> <span class="token operator">-</span>u root <span class="token operator">-</span>p
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>（3）客户端和服务器在同一台机器上，所以输入localhost或者IP地址127.0.0.1。同时，因为是连接本机：
-hlocalhost就可以省略，如果端口号没有修改：-P3306也可以省略</p>
<p>简写成：</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code>mysql <span class="token operator">-</span>u root <span class="token operator">-</span>p
Enter password:<span class="token operator">*</span><span class="token operator">*</span><span class="token operator">*</span><span class="token operator">*</span>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>c:\> mysql -V
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>c:\> mysql --version
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>mysql> select version();
...
<div class="language-ini ext-ini line-numbers-mode"><pre v-pre class="language-ini"><code><span class="token section"><span class="token punctuation">[</span><span class="token section-name selector">mysql</span><span class="token punctuation">]</span></span>  #大概在63行左右，在其下添加
... 
...
<p>步骤3：重启服务</p>
<p>步骤4：查看编码命令</p>
<div class="language-sql ext-sql line-numbers-mode"><pre v-pre class="language-sql"><code><span class="token keyword">show</span> variables <span class="token operator">like</span> <span class="token string">'character_%'</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><img src="@source/notes/base_mysql/images/MySQL编码1.jpg" style="zoom:90%;" />
<img src="@source/notes/base_mysql/images/MySQL编码2.jpg" style="zoom:90%;" />
<ul>
...
<img src="@source/notes/base_mysql/images/image-20211014195142849.png" alt="image-20211014195142849" style="zoom:80%;" />
...
<img src="@source/notes/base_mysql/images/image-20211014195309805.png" alt="image-20211014195309805" style="zoom:70%;" />
...
<p>3: 此时，mysqld服务进程已经打开。并且不需要权限检查
