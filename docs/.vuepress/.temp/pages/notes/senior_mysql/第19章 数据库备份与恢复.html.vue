<template><div><h1 id="第19章-数据库备份与恢复" tabindex="-1"><a class="header-anchor" href="#第19章-数据库备份与恢复" aria-hidden="true">#</a> 第19章_数据库备份与恢复</h1>
<img src="@source/notes/senior_mysql/images/image-20220718145936444.png" alt="image-20220718145936444" style="float:left;" />
<h2 id="_1-物理备份与逻辑备份" tabindex="-1"><a class="header-anchor" href="#_1-物理备份与逻辑备份" aria-hidden="true">#</a> 1. 物理备份与逻辑备份</h2>
<p>**物理备份：**备份数据文件，转储数据库物理文件到某一目录。物理备份恢复速度比较快，但占用空间比较大，MySQL中可以用 <code v-pre>xtrabackup</code> 工具来进行物理备份。</p>
<p>**逻辑备份：**对数据库对象利用工具进行导出工作，汇总入备份文件内。逻辑备份恢复速度慢，但占用空间小，更灵活。MySQL 中常用的逻辑备份工具为 <code v-pre>mysqldump</code> 。逻辑备份就是 <code v-pre>备份sql语句</code> ，在恢复的 时候执行备份的sql语句实现数据库数据的重现。</p>
...
<img src="@source/notes/senior_mysql/images/image-20220718165909464.png" alt="image-20220718165909464" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220718170026929.png" alt="image-20220718170026929" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220718170132339.png" alt="image-20220718170132339" style="float:left;" />
<img src="@source/notes/senior_mysql/images/image-20220718170215247.png" alt="image-20220718170215247" style="float:left;" />
