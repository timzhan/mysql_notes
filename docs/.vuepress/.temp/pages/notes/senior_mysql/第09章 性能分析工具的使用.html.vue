...
<p><img src="@source/notes/senior_mysql/images/image-20220627162248635.png" alt="image-20220627162248635"></p>
<p><img src="@source/notes/senior_mysql/images/image-20220627162345815.png" alt="image-20220627162345815"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SHOW [GLOBAL|SESSION] STATUS LIKE '参数';
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SHOW STATUS LIKE 'Connections';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>若查询服务器工作时间，则可以执行如下语句:</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SHOW STATUS LIKE 'Uptime';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>若查询MySQL服务器的慢查询次数，则可以执行如下语句:</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SHOW STATUS LIKE 'Slow_queries';
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SHOW STATUS LIKE 'Innodb_rows_%';
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>CREATE TABLE `student_info` (
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SELECT student_id, class_id, NAME, create_time FROM student_info WHERE id = 900001;
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; SHOW STATUS LIKE 'last_query_cost';
+-----------------+----------+
| Variable_name   |   Value  |
+-----------------+----------+
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SELECT student_id, class_id, NAME, create_time FROM student_info WHERE id BETWEEN 900001 AND 900100;
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql &gt; show variables like '%slow_query_log';
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql &gt; set global slow_query_log='ON';
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql &gt; show variables like '%long_query_time%';
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>#测试发现：设置global的方式对当前session的long_query_time失效。对新连接的客户端有效。所以可以一并
执行下述语句
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SHOW GLOBAL STATUS LIKE '%Slow_queries%';
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>#调用刚刚写好的函数, 4000000条记录,从100001号开始
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; SELECT * FROM student WHERE stuno = 3455655;
+---------+---------+--------+------+---------+
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SHOW VARIABLES LIKE '%slow%'; #查询慢查询日志所在目录
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SET GLOBAL slow_query_log=off;
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SHOW VARIABLES LIKE '%slow%';
#以及
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SHOW VARIABLES LIKE `slow_query_log%`;
...
<p>我们可以在会话级别开启这个功能。</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql &gt; show variables like 'profiling';
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql &gt; set profiling = 'ON';
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql &gt; show profiles;
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; show profile cpu,block io for query 2
...
<p>https://dev.mysql.com/doc/refman/5.7/en/explain-output.html</p>
<p>https://dev.mysql.com/doc/refman/8.0/en/explain-output.html</p>
<p><img src="@source/notes/senior_mysql/images/image-20220628211207436.png" alt="image-20220628211207436"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>EXPLAIN SELECT select_options
或者
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT 1;
...
<p><img src="@source/notes/senior_mysql/images/image-20220628212049096.png" alt="image-20220628212049096"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>CREATE TABLE s1 (
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>CALL insert_s1(10001,10000);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>s2表数据的添加：加入1万条记录：</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>CALL insert_s2(10001,10000);
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql &gt; EXPLAIN SELECT * FROM s1;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220628221143339.png" alt="image-20220628221143339"></p>
<p>这个查询语句只涉及对s1表的单表查询，所以 <code v-pre>EXPLAIN</code> 输出中只有一条记录，其中的table列的值为s1，表明这条记录是用来说明对s1表的单表访问方法的。</p>
<p>下边我们看一个连接查询的执行计划</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql &gt; EXPLAIN SELECT * FROM s1 INNER JOIN s2;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220628221414097.png" alt="image-20220628221414097"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SELECT * FROM s1 WHERE key1 = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>稍微复杂一点的连接查询中也只有一个 SELECT 关键字，比如：</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SELECT * FROM s1 INNER JOIN s2
ON s1.key1 = s2.key1
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql &gt; EXPLAIN SELECT * FROM s1 WHERE key1 = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220628222055716.png" alt="image-20220628222055716"></p>
<p>对于连接查询来说，一个SELECT关键字后边的FROM字句中可以跟随多个表，所以在连接查询的执行计划中，每个表都会对应一条记录，但是这些记录的id值都是相同的，比如：</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 INNER JOIN s2;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220628222251309.png" alt="image-20220628222251309"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 IN (SELECT key1 FROM s2) OR key3 = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220629165122837.png" alt="image-20220629165122837"></p>
<img src="@source/notes/senior_mysql/images/image-20220629170848349.png" alt="image-20220629170848349" style="float:left;" />
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code># 查询优化器可能对涉及子查询的查询语句进行重写，转变为多表查询的操作。  
mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 IN (SELECT key2 FROM s2 WHERE common_field = 'a');
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220629165603072.png" alt="image-20220629165603072"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code># Union去重
mysql&gt; EXPLAIN SELECT * FROM s1 UNION SELECT * FROM s2;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220629165909340.png" alt="image-20220629165909340"></p>
<img src="@source/notes/senior_mysql/images/image-20220629171104375.png" alt="image-20220629171104375" style="float:left;" />
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 UNION ALL SELECT * FROM s2;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220629171138065.png" alt="image-20220629171138065"></p>
...
<p><img src="@source/notes/senior_mysql/images/image-20220629171442624.png" alt="image-20220629171442624"></p>
<p>具体分析如下：</p>
<ul>
<li>
<p>SIMPLE</p>
...
<p><img src="@source/notes/senior_mysql/images/image-20220629171840300.png" alt="image-20220629171840300"></p>
<p>​        当然，连接查询也算是 SIMPLE 类型，比如：</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 INNER JOIN s2;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220629171904912.png" alt="image-20220629171904912"></p>
<ul>
<li>
<p>PRIMARY</p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 UNION SELECT * FROM s2;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220629171929924.png" alt="image-20220629171929924"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 IN (SELECT key1 FROM s2) OR key3 = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220629172449267.png" alt="image-20220629172449267"></p>
</li>
<li>
<p>DEPENDENT SUBQUERY</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 IN (SELECT key1 FROM s2 WHERE s1.key2 = s2.key2) OR key3 = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220629172525236.png" alt="image-20220629172525236"></p>
</li>
<li>
<p>DEPENDENT UNION</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 IN (SELECT key1 FROM s2 WHERE key1 = 'a' UNION SELECT key1 FROM s1 WHERE key1 = 'b');
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220629172555603.png" alt="image-20220629172555603"></p>
</li>
<li>
<p>DERIVED</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM (SELECT key1, count(*) as c FROM s1 GROUP BY key1) AS derived_s1 where c &gt; 1;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220629172622893.png" alt="image-20220629172622893"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 IN (SELECT key1 FROM s2);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220629172646367.png" alt="image-20220629172646367"></p>
</li>
<li>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>-- 创建分区表，
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>DESC SELECT * FROM user_partitions WHERE id&gt;200;
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; CREATE TABLE t(i int) Engine=MyISAM;
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM t;
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE id = 10005;
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 INNER JOIN s2 ON s1.id = s2.id;
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 = 'a' OR key1 IS NULL;
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 = 'a' OR key3 = 'a';
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key2 IN (SELECT id FROM s2 where s1.key1 = s2.key1) OR key3 = 'a';
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE common_field IN (SELECT key3 FROM s2 where s1.key1 = s2.key1) OR key3 = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div></li>
</ul>
<p><img src="@source/notes/senior_mysql/images/image-20220703214407225.png" alt="image-20220703214407225"></p>
<ul>
<li>
<p><code v-pre>range</code></p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 IN ('a', 'b', 'c');
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220703214633338.png" alt="image-20220703214633338"></p>
<p>或者：</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 &gt; 'a' AND key1 &lt; 'b';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220703214657251.png" alt="image-20220703214657251"></p>
</li>
<li>
<p><code v-pre>index</code></p>
<p>当我们可以使用索引覆盖，但需要扫描全部的索引记录时，该表的访问方法就是<code v-pre>index</code>，比如这样：</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT key_part2 FROM s1 WHERE key_part3 = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220703214844885.png" alt="image-20220703214844885"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220703215958374.png" alt="image-20220703215958374"></p>
</li>
</ul>
<p>**小结: **</p>
<p>**结果值从最好到最坏依次是： **</p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 &gt; 'z' AND key3 = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220703220724964.png" alt="image-20220703220724964"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE id = 10005;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704130030692.png" alt="image-20220704130030692"></p>
<blockquote>
<p>int 占用 4 个字节</p>
</blockquote>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key2 = 10126;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704130138204.png" alt="image-20220704130138204"></p>
<blockquote>
<p>key2上有一个唯一性约束，是否为NULL占用一个字节，那么就是5个字节</p>
</blockquote>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704130214482.png" alt="image-20220704130214482"></p>
<blockquote>
<p>key1 VARCHAR(100) 一个字符占3个字节，100*3，是否为NULL占用一个字节，varchar的长度信息占两个字节。</p>
</blockquote>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key_part1 = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704130442095.png" alt="image-20220704130442095"></p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key_part1 = 'a' AND key_part2 = 'b';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704130515031.png" alt="image-20220704130515031"></p>
<blockquote>
<p>联合索引中可以比较，key_len=606的好于key_len=303</p>
</blockquote>
<p>**练习： **</p>
<p>key_len的长度计算公式：</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>varchar(10)变长字段且允许NULL = 10 * ( character set：utf8=3,gbk=2,latin1=1)+1(NULL)+2(变长字段)
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704130837498.png" alt="image-20220704130837498"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 INNER JOIN s2 ON s1.id = s2.id;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704130925426.png" alt="image-20220704130925426"></p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 INNER JOIN s2 ON s2.key1 = UPPER(s1.key1);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704130957359.png" alt="image-20220704130957359"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 &gt; 'z';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704131050496.png" alt="image-20220704131050496"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 &gt; 'z' AND common_field = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704131323242.png" alt="image-20220704131323242"></p>
<p>对于单表查询来说，这个filtered的值没有什么意义，我们<code v-pre>更关注在连接查询中驱动表对应的执行计划记录的filtered值</code>，它决定了被驱动表要执行的次数 (即: rows * filtered)</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 INNER JOIN s2 ON s1.key1 = s2.key1 WHERE s1.common_field = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704131644615.png" alt="image-20220704131644615"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT 1;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704132345383.png" alt="image-20220704132345383"></p>
</li>
<li>
<p><code v-pre>Impossible WHERE</code></p>
<p>当查询语句的<code v-pre>WHERE</code>子句永远为<code v-pre>FALSE</code>时将会提示该额外信息</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE 1 != 1;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704132458978.png" alt="image-20220704132458978"></p>
</li>
<li>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE common_field = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704132655342.png" alt="image-20220704132655342"></p>
<img src="@source/notes/senior_mysql/images/image-20220704140212813.png" alt="image-20220704140212813" style="float:left;" />
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 = 'a' AND common_field = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704133130515.png" alt="image-20220704133130515"></p>
</li>
<li>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT MIN(key1) FROM s1 WHERE key1 = 'abcdefg';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704134324354.png" alt="image-20220704134324354"></p>
</li>
<li>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT key1 FROM s1 WHERE key1 = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704134931220.png" alt="image-20220704134931220"></p>
</li>
<li>
<p><code v-pre>Using index condition</code></p>
<p>有些搜索条件中虽然出现了索引列，但却不能使用到索引，比如下边这个查询：</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SELECT * FROM s1 WHERE key1 &gt; 'z' AND key1 LIKE '%a';
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 &gt; 'z' AND key1 LIKE '%b';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704140441702.png" alt="image-20220704140441702"></p>
</li>
<li>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 INNER JOIN s2 ON s1.common_field = s2.common_field;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704140815955.png" alt="image-20220704140815955"></p>
</li>
<li>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 LEFT JOIN s2 ON s1.key1 = s2.key1 WHERE s2.id IS NULL;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704142059555.png" alt="image-20220704142059555"></p>
</li>
<li>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 WHERE key1 = 'a' OR key3 = 'a';
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704142552890.png" alt="image-20220704142552890"></p>
</li>
<li>
<p><code v-pre>Zero limit</code></p>
<p>当我们的<code v-pre>LIMIT</code>子句的参数为<code v-pre>0</code>时，表示压根儿不打算从表中读取任何记录，将会提示该额外信息</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 LIMIT 0;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704142754394.png" alt="image-20220704142754394"></p>
</li>
<li>
<p><code v-pre>Using filesort</code></p>
<p>有一些情况下对结果集中的记录进行排序是可以使用到索引的。</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 ORDER BY key1 LIMIT 10;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704142901857.png" alt="image-20220704142901857"></p>
<img src="@source/notes/senior_mysql/images/image-20220704145143170.png" alt="image-20220704145143170" style="float:left;" />
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT * FROM s1 ORDER BY common_field LIMIT 10;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704143518857.png" alt="image-20220704143518857"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT DISTINCT common_field FROM s1;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704150030005.png" alt="image-20220704150030005"></p>
<p>再比如：</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT common_field, COUNT(*) AS amount FROM s1 GROUP BY common_field;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704150156416.png" alt="image-20220704150156416"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT key1, COUNT(*) AS amount FROM s1 GROUP BY key1;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704150308189.png" alt="image-20220704150308189"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT s1.key1, s2.key1 FROM s1 LEFT JOIN s2 ON s1.key1 = s2.key1 WHERE s2.common_field IS NOT NULL;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704161702384.png" alt="image-20220704161702384"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>EXPLAIN FORMAT=JSON SELECT ....
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>EXPLAIN的Column与JSON的对应关系：(来源于MySQL 5.7文档)</li>
</ul>
<p><img src="@source/notes/senior_mysql/images/image-20220704164236909.png" alt="image-20220704164236909"></p>
<p>这样我们就可以得到一个json格式的执行计划，里面包含该计划花费的成本。比如这样：</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN FORMAT=JSON SELECT * FROM s1 INNER JOIN s2 ON s1.key1 = s2.key2 WHERE s1.common_field = 'a'\G
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704172833362.png" alt="image-20220704172833362"></p>
<p><img src="@source/notes/senior_mysql/images/image-20220704172920158.png" alt="image-20220704172920158"></p>
<p><img src="@source/notes/senior_mysql/images/image-20220704173012413.png" alt="image-20220704173012413"></p>
<p><img src="@source/notes/senior_mysql/images/image-20220704173045190.png" alt="image-20220704173045190"></p>
<p><img src="@source/notes/senior_mysql/images/image-20220704173108888.png" alt="image-20220704173108888"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN FORMAT=tree SELECT * FROM s1 INNER JOIN s2 ON s1.key1 = s2.key2 WHERE
s1.common_field = 'a'\G
*************************** 1. row ***************************
...
<p><img src="@source/notes/senior_mysql/images/image-20220704174401970.png" alt="image-20220704174401970"></p>
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; EXPLAIN SELECT s1.key1, s2.key1 FROM s1 LEFT JOIN s2 ON s1.key1 = s2.key1 WHERE s2.common_field IS NOT NULL;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="@source/notes/senior_mysql/images/image-20220704174543663.png" alt="image-20220704174543663"></p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>mysql&gt; SHOW WARNINGS\G
*************************** 1. row ***************************
    Level: Note
     Code: 1003
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>SET optimizer_trace=&quot;enabled=on&quot;,end_markers_in_json=on;
...
<p>测试：执行如下SQL语句</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>select * from student where id &lt; 10;
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>select * from information_schema.optimizer_trace\G
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>*************************** 1. row ***************************
//第1部分：查询语句
...
<p>索引情况</p>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>#1. 查询冗余索引
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code># 1. 查询表的访问量
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>#1. 监控SQL执行的频率
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>#1. 查看消耗磁盘IO的文件
...
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>#1. 行锁阻塞情况
