<template><div><h1 id="第12章-数据库其它调优策略" tabindex="-1"><a class="header-anchor" href="#第12章-数据库其它调优策略" aria-hidden="true">#</a> 第12章_数据库其它调优策略</h1>
...
<img src="@source/notes/senior_mysql/images/image-20220707200915836.png" alt="image-20220707200915836" style="float:left;" />
<p>如何确定呢？一般情况下，有如下几种方式：</p>
<img src="@source/notes/senior_mysql/images/image-20220707201133424.png" alt="image-20220707201133424" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707201443229.png" alt="image-20220707201443229" style="float:left;" />
<h4 id="第2步-优化表设计" tabindex="-1"><a class="header-anchor" href="#第2步-优化表设计" aria-hidden="true">#</a> 第2步：优化表设计</h4>
<img src="@source/notes/senior_mysql/images/image-20220707201617799.png" alt="image-20220707201617799" style="float:left;" />
<h4 id="第3步-优化逻辑查询" tabindex="-1"><a class="header-anchor" href="#第3步-优化逻辑查询" aria-hidden="true">#</a> 第3步：优化逻辑查询</h4>
<img src="@source/notes/senior_mysql/images/image-20220707202059972.png" alt="image-20220707202059972" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707202156660.png" alt="image-20220707202156660" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707202436467.png" alt="image-20220707202436467" style="float:left;" />
<h4 id="第6步-库级优化" tabindex="-1"><a class="header-anchor" href="#第6步-库级优化" aria-hidden="true">#</a> 第6步：库级优化</h4>
<img src="@source/notes/senior_mysql/images/image-20220707202555506.png" alt="image-20220707202555506" style="float:left;" />
<img src="@source/notes/senior_mysql/images/image-20220707202732911.png" alt="image-20220707202732911" style="float:left;" />
<img src="@source/notes/senior_mysql/images/image-20220707203538155.png" alt="image-20220707203538155" style="float:left;" />
<img src="@source/notes/senior_mysql/images/image-20220707203607993.png" alt="image-20220707203607993" style="float:left;" />
<blockquote>
...
<img src="@source/notes/senior_mysql/images/image-20220707203818987.png" alt="image-20220707203818987" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707204403406.png" alt="image-20220707204403406" style="float:left;" />
<ul>
<li>
...
<img src="@source/notes/senior_mysql/images/image-20220707210447501.png" alt="image-20220707210447501" style="float:left;" />
<p><strong>(2)  调整系统参数 InnoDB_buffer_pool_size</strong></p>
<img src="@source/notes/senior_mysql/images/image-20220707210555848.png" alt="image-20220707210555848" style="float:left;" />
<p><strong>(3) 调整系统参数 InnoDB_buffer_pool_instances</strong></p>
<img src="@source/notes/senior_mysql/images/image-20220707210720394.png" alt="image-20220707210720394" style="float:left;" />
<h2 id="_3-优化数据库结构" tabindex="-1"><a class="header-anchor" href="#_3-优化数据库结构" aria-hidden="true">#</a> 3. 优化数据库结构</h2>
<img src="@source/notes/senior_mysql/images/image-20220707211709553.png" alt="image-20220707211709553" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707213524137.png" alt="image-20220707213524137" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707214640374.png" alt="image-20220707214640374" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707215305640.png" alt="image-20220707215305640" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707220034534.png" alt="image-20220707220034534" style="float:left;" />
<p><strong>③ 禁止自动提交</strong></p>
<img src="@source/notes/senior_mysql/images/image-20220707220131891.png" alt="image-20220707220131891" style="float:left;" />
<h3 id="_3-6-使用非空约束" tabindex="-1"><a class="header-anchor" href="#_3-6-使用非空约束" aria-hidden="true">#</a> 3.6 使用非空约束</h3>
<img src="@source/notes/senior_mysql/images/image-20220707220157606.png" alt="image-20220707220157606" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707222156765.png" alt="image-20220707222156765" style="float:left;" />
<p><strong>方式二：使用mysqlcheck命令</strong></p>
<img src="@source/notes/senior_mysql/images/image-20220707222305302.png" alt="image-20220707222305302" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707223420496.png" alt="image-20220707223420496" style="float:left;" />
</div></template>
