...
<h4 id="_1-用户管理" tabindex="-1"><a class="header-anchor" href="#_1-用户管理" aria-hidden="true">#</a> <strong>1.</strong> <strong>用户管理</strong></h4>
<h5 id="_1-1-登录mysql服务器" tabindex="-1"><a class="header-anchor" href="#_1-1-登录mysql服务器" aria-hidden="true">#</a> <strong>1.1</strong> <strong>登录MySQL服务器</strong></h5>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="_1-2-创建用户" tabindex="-1"><a class="header-anchor" href="#_1-2-创建用户" aria-hidden="true">#</a> <strong>1.2</strong> <strong>创建用户</strong></h5>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_1-3-修改用户" tabindex="-1"><a class="header-anchor" href="#_1-3-修改用户" aria-hidden="true">#</a> <strong>1.3</strong> <strong>修改用户</strong></h5>
...
FLUSH PRIVILEGES;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_1-4-删除用户" tabindex="-1"><a class="header-anchor" href="#_1-4-删除用户" aria-hidden="true">#</a> <strong>1.4</strong> <strong>删除用户</strong></h5>
...
FLUSH PRIVILEGES;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_1-5-设置当前用户密码" tabindex="-1"><a class="header-anchor" href="#_1-5-设置当前用户密码" aria-hidden="true">#</a> <strong>1.5</strong> <strong>设置当前用户密码</strong></h5>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="_1-6-修改其它用户密码" tabindex="-1"><a class="header-anchor" href="#_1-6-修改其它用户密码" aria-hidden="true">#</a> <strong>1.6</strong> <strong>修改其它用户密码</strong></h5>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="_2-权限管理" tabindex="-1"><a class="header-anchor" href="#_2-权限管理" aria-hidden="true">#</a> <strong>2.</strong> <strong>权限管理</strong></h4>
<h5 id="_2-1-权限列表" tabindex="-1"><a class="header-anchor" href="#_2-1-权限列表" aria-hidden="true">#</a> <strong>2.1</strong> <strong>权限列表</strong></h5>
...
<h5 id="_2-2-授予权限的原则" tabindex="-1"><a class="header-anchor" href="#_2-2-授予权限的原则" aria-hidden="true">#</a> <strong>2.2</strong> <strong>授予权限的原则</strong></h5>
...
<h5 id="_2-3-授予权限" tabindex="-1"><a class="header-anchor" href="#_2-3-授予权限" aria-hidden="true">#</a> <strong>2.3</strong> <strong>授予权限</strong></h5>
...
<h5 id="_2-4-查看权限" tabindex="-1"><a class="header-anchor" href="#_2-4-查看权限" aria-hidden="true">#</a> <strong>2.4</strong> <strong>查看权限</strong></h5>
<ul>
<li>查看当前用户权限</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="_2-5-收回权限" tabindex="-1"><a class="header-anchor" href="#_2-5-收回权限" aria-hidden="true">#</a> <strong>2.5</strong> <strong>收回权限</strong></h5>
...
<h4 id="_3-角色管理" tabindex="-1"><a class="header-anchor" href="#_3-角色管理" aria-hidden="true">#</a> <strong>3.</strong> <strong>角色管理</strong></h4>
<h5 id="_3-1-创建角色" tabindex="-1"><a class="header-anchor" href="#_3-1-创建角色" aria-hidden="true">#</a> <strong>3.1</strong> <strong>创建角色</strong></h5>
...
<h5 id="_3-2-给角色赋予权限" tabindex="-1"><a class="header-anchor" href="#_3-2-给角色赋予权限" aria-hidden="true">#</a> <strong>3.2</strong> <strong>给角色赋予权限</strong></h5>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="_3-3-查看角色的权限" tabindex="-1"><a class="header-anchor" href="#_3-3-查看角色的权限" aria-hidden="true">#</a> <strong>3.3</strong> <strong>查看角色的权限</strong></h5>
...
<h5 id="_3-4-回收角色的权限" tabindex="-1"><a class="header-anchor" href="#_3-4-回收角色的权限" aria-hidden="true">#</a> <strong>3.4</strong> <strong>回收角色的权限</strong></h5>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="_3-5-删除角色" tabindex="-1"><a class="header-anchor" href="#_3-5-删除角色" aria-hidden="true">#</a> <strong>3.5</strong> <strong>删除角色</strong></h5>
...
<h5 id="_3-6-给用户赋予角色" tabindex="-1"><a class="header-anchor" href="#_3-6-给用户赋予角色" aria-hidden="true">#</a> <strong>3.6</strong> <strong>给用户赋予角色</strong></h5>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="_3-7-激活角色" tabindex="-1"><a class="header-anchor" href="#_3-7-激活角色" aria-hidden="true">#</a> <strong>3.7</strong> <strong>激活角色</strong></h5>
...
<h5 id="_3-8-撤销用户的角色" tabindex="-1"><a class="header-anchor" href="#_3-8-撤销用户的角色" aria-hidden="true">#</a> <strong>3.8</strong> <strong>撤销用户的角色</strong></h5>
<div class="language-mysql ext-mysql line-numbers-mode"><pre v-pre class="language-mysql"><code>REVOKE role FROM user;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="_3-9-设置强制角色-mandatory-role" tabindex="-1"><a class="header-anchor" href="#_3-9-设置强制角色-mandatory-role" aria-hidden="true">#</a> <strong>3.9</strong> <strong>设置强制角色(mandatory role)</strong></h5>
<p>方式1：服务启动前设置</p>
