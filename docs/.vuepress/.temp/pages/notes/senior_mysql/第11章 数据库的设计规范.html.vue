<template><div><h1 id="第11章-数据库的设计规范" tabindex="-1"><a class="header-anchor" href="#第11章-数据库的设计规范" aria-hidden="true">#</a> 第11章_数据库的设计规范</h1>
<h2 id="_1-为什么需要数据库设计" tabindex="-1"><a class="header-anchor" href="#_1-为什么需要数据库设计" aria-hidden="true">#</a> 1. 为什么需要数据库设计</h2>
<img src="@source/notes/senior_mysql/images/image-20220706164201695.png" alt="image-20220706164201695" style="zoom:80%;float:left" />
<img src="@source/notes/senior_mysql/images/image-20220706164359539.png" alt="image-20220706164359539" style="zoom:80%;float:left" />
...
<img src="@source/notes/senior_mysql/images/image-20220707124343085.png" alt="image-20220707124343085" style="zoom:80%;float:left" />
...
<img src="@source/notes/senior_mysql/images/image-20220707124741675.png" alt="image-20220707124741675" style="zoom:80%;float:left" />
...
<p>我们分析如下表的范式情况：</p>
<img src="@source/notes/senior_mysql/images/image-20220707131428597.png" alt="image-20220707131428597" style="zoom:80%;" />
...
<p>商品信息表：</p>
<img src="@source/notes/senior_mysql/images/image-20220707163807205.png" alt="image-20220707163807205" style="float:left;" />
<p>进货单表：</p>
<img src="@source/notes/senior_mysql/images/image-20220707163828614.png" alt="image-20220707163828614" style="float:left;" />
...
<p>供货商表：</p>
<img src="@source/notes/senior_mysql/images/image-20220707165011050.png" alt="image-20220707165011050" style="float:left;" />
<p>进货单头表：</p>
<img src="@source/notes/senior_mysql/images/image-20220707165038108.png" alt="image-20220707165038108" style="float:left;" />
<p>这2个表都满足第三范式的要求了。</p>
<h3 id="_7-4-反范式化-业务优先的原则" tabindex="-1"><a class="header-anchor" href="#_7-4-反范式化-业务优先的原则" aria-hidden="true">#</a> 7.4 反范式化：业务优先的原则</h3>
<img src="@source/notes/senior_mysql/images/image-20220707165459547.png" alt="image-20220707165459547" style="zoom:80%;float:left" />
...
<img src="@source/notes/senior_mysql/images/image-20220707165038108.png" alt="image-20220707165038108" style="float:left;" />
<p>进货单明细表：</p>
<img src="@source/notes/senior_mysql/images/image-20220707164146216.png" alt="image-20220707164146216" style="zoom:80%;float:left" />
<p>商品信息表：</p>
<img src="@source/notes/senior_mysql/images/image-20220707164227845.png" alt="image-20220707164227845" style="zoom:80%;float:left" />
...
<img src="@source/notes/senior_mysql/images/image-20220707170027637.png" alt="image-20220707170027637" style="zoom:80%;float:left" />
...
<img src="@source/notes/senior_mysql/images/image-20220707171335255.png" alt="image-20220707171335255" style="float:left;" />
<img src="@source/notes/senior_mysql/images/image-20220707171412363.png" alt="image-20220707171412363" style="float:left;" />
<img src="@source/notes/senior_mysql/images/image-20220707171915637.png" alt="image-20220707171915637" style="float:left;" />
<p><strong>下面我们再把弱实体转换成数据表：</strong></p>
<img src="@source/notes/senior_mysql/images/image-20220707172033399.png" alt="image-20220707172033399" style="float:left;" />
<img src="@source/notes/senior_mysql/images/image-20220707172052236.png" alt="image-20220707172052236" style="float:left;" />
<img src="@source/notes/senior_mysql/images/image-20220707172143793.png" alt="image-20220707172143793" style="float:left;" />
<img src="@source/notes/senior_mysql/images/image-20220707172217772.png" alt="image-20220707172217772" style="float:left;" />
<img src="@source/notes/senior_mysql/images/image-20220707172236606.png" alt="image-20220707172236606" style="float:left;" />
<img src="@source/notes/senior_mysql/images/image-20220707172259143.png" alt="image-20220707172259143" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707172350226.png" alt="image-20220707172350226" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707173028203.png" alt="image-20220707173028203" style="float:left;" />
<p><strong>2. 数据表中的字段个数越少越好</strong></p>
<img src="@source/notes/senior_mysql/images/image-20220707173402491.png" alt="image-20220707173402491" style="float:left;" />
<p><strong>3. 数据表中联合主键的字段个数越少越好</strong></p>
<img src="@source/notes/senior_mysql/images/image-20220707173522971.png" alt="image-20220707173522971" style="float:left;" />
<p><strong>4. 使用主键和外键越多越好</strong></p>
<img src="@source/notes/senior_mysql/images/image-20220707173557568.png" alt="image-20220707173557568" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707175250944.png" alt="image-20220707175250944" style="zoom:80%;float:left" />
...
<img src="@source/notes/senior_mysql/images/image-20220707175350250.png" alt="image-20220707175350250" style="float:left;" />
<p>点击上面的ok，即可出现下图左边的概念模型1，可以自定义概念模型的名字，在概念模型中使用最多的 就是如图所示的Entity(实体),Relationship(关系)</p>
<img src="@source/notes/senior_mysql/images/image-20220707175604026.png" alt="image-20220707175604026" style="float:left;" />
<p><strong>Entity实体</strong></p>
<p>选中右边框中Entity这个功能，即可出现下面这个方框，需要注意的是书写name的时候，code自行补全，name可以是英文的也可以是中文的，但是code必须是英文的。</p>
<img src="@source/notes/senior_mysql/images/image-20220707175653689.png" alt="image-20220707175653689" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707175805226.png" alt="image-20220707175805226" style="float:left;" />
<p>在此上图说明name和code的起名方法</p>
<img src="@source/notes/senior_mysql/images/image-20220707175827417.png" alt="image-20220707175827417" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707175858031.png" alt="image-20220707175858031" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707175925155.png" alt="image-20220707175925155" style="float:left;" />
...
<p>如图所示</p>
<img src="@source/notes/senior_mysql/images/image-20220707175954634.png" alt="image-20220707175954634" style="float:left;" />
<p>需要注意的是点击Relationship这个按钮，就把班级和学生联系起来了，就是一条线，然后双击这条线进 行编辑，在General这块起name和code</p>
<img src="@source/notes/senior_mysql/images/image-20220707180021612.png" alt="image-20220707180021612" style="float:left;" />
<p>上面的name和code起好后就可以在Cardinalities这块查看班级和学生的关系，可以看到班级的一端是一 条线，学生的一端是三条，代表班级对学生是一对多的关系即one对many的关系，点击应用，然后确定 即可</p>
<img src="@source/notes/senior_mysql/images/image-20220707180044291.png" alt="image-20220707180044291" style="float:left;" />
<p>一对多和多对一练习完还有多对多的练习，如下图操作所示，老师实体和上面介绍的一样，自己将 name，data type等等修改成自己需要的即可，满足项目开发需求即可。（comment是解释说明，自己可以写相关的介绍和说明）</p>
<img src="@source/notes/senior_mysql/images/image-20220707180113532.png" alt="image-20220707180113532" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707180418090.png" alt="image-20220707180418090" style="float:left;" />
<p>鼠标先点击右边table这个按钮然后在新建的物理模型点一下，即可新建一个表，然后双击新建如下图所示，在General的name和code填上自己需要的，点击应用即可），如下图：</p>
<img src="@source/notes/senior_mysql/images/image-20220707180449212.png" alt="image-20220707180449212" style="float:left;" />
<p>然后点击Columns,如下图设置，非常简单，需要注意的就是P（primary主键） , F （foreign key外键） , M（mandatory强制性的，代表不可为空） 这三个。</p>
<img src="@source/notes/senior_mysql/images/image-20220707180537251.png" alt="image-20220707180537251" style="float:left;" />
<p>在此设置学号的自增（MYSQL里面的自增是这个AUTO_INCREMENT），班级编号同理，不多赘述！</p>
<img src="@source/notes/senior_mysql/images/image-20220707180556645.png" alt="image-20220707180556645" style="float:left;" />
<p>在下面的这个点上对号即可，就设置好了自增</p>
<img src="@source/notes/senior_mysql/images/image-20220707180619440.png" alt="image-20220707180619440" style="float:left;" />
<p>全部完成后如下图所示。</p>
<img src="@source/notes/senior_mysql/images/image-20220707180643107.png" alt="image-20220707180643107" style="float:left;" />
<p>班级物理模型同理如下图所示创建即可</p>
<img src="@source/notes/senior_mysql/images/image-20220707180723698.png" alt="image-20220707180723698" style="float:left;" />
<img src="@source/notes/senior_mysql/images/image-20220707180744600.png" alt="image-20220707180744600" style="float:left;" />
<p>完成后如下图所示</p>
<img src="@source/notes/senior_mysql/images/image-20220707180806150.png" alt="image-20220707180806150" style="float:left;" />
...
<img src="@source/notes/senior_mysql/images/image-20220707180828164.png" alt="image-20220707180828164" style="float:left;" />
<p>做完上面的操作，就可以双击中间的一条线，显示如下图，修改name和code即可</p>
<img src="@source/notes/senior_mysql/images/image-20220707183743297.png" alt="image-20220707183743297" style="float:left;" />
<p>但是需要注意的是，修改完毕后显示的结果却如下图所示，并没有办法直接像概念模型那样，修改过后 显示在中间的那条线上面，自己明白即可。</p>
<img src="@source/notes/senior_mysql/images/image-20220707193816176.png" alt="image-20220707193816176" style="float:left;" />
<p>学习了多对一或者一对多的关系，接下来学习多对对的关系，同理自己建好老师表，这里不在叙述，记得老师编号自增，建好如下图所示</p>
<img src="@source/notes/senior_mysql/images/image-20220707193932694.png" alt="image-20220707193932694" style="float:left;" />
<p>下面是多对多关系的关键，由于物理模型多对多的关系需要一个中间表来连接，如下图，只设置一个字 段，主键，自增</p>
<img src="@source/notes/senior_mysql/images/image-20220707193957629.png" alt="image-20220707193957629" style="float:left;" />
<p>点击应用，然后设置Columns，只添加一个字段</p>
<img src="@source/notes/senior_mysql/images/image-20220707194048843.png" alt="image-20220707194048843" style="float:left;" />
<p>这是设置字段递增，前面已经叙述过好几次</p>
<img src="@source/notes/senior_mysql/images/image-20220707194111885.png" alt="image-20220707194111885" style="float:left;" />
<p>设置好后如下图所示，需要注意的是有箭头的一方是一，无箭头的一方是多，即一对多的多对一的关系 需要搞清楚，学生也可以有很多老师，老师也可以有很多学生，所以学生和老师都可以是主体；</p>
<img src="@source/notes/senior_mysql/images/image-20220707194138137.png" alt="image-20220707194138137" style="float:left;" />
